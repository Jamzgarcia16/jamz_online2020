...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-02-2019 a las 02:43:28
...
(68, 'apartamento desde php edit', 'nuevo el pirobo', '2000000'),
(70, 'otro', 'apar Nuevo', '20000');
...
(15, 'Admón Videos', 'adm_videos', '<i class=\"fa fa-desktop\"></i>', 'adm_videos'),
(16, 'Admón Galeria ', 'adm_galeria', '<i class=\"fa fa-bed\"></i>', 'adm_galeria'),
(17, 'adm_galeria_rock', 'adm_rock', '<i class=\"fa fa-address-card\"></i>', 'adm_rock');
...
--
ALTER TABLE `apartamentos`
  MODIFY `id_apartamento` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;

--
-- AUTO_INCREMENT de la tabla `aux_perfiles_menus`
--
ALTER TABLE `aux_perfiles_menus`
  MODIFY `id_aux` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `perfiles`
  MODIFY `id_perfil` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
