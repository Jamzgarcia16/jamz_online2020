...
CREATE TABLE `empleados` (
  ...
  `sal_enero` int(20) NOT NULL,
  `sal_feb` int(20) NOT NULL,
  `sal_mar` int(20) NOT NULL,
  `sal_abr` int(20) NOT NULL,
...
INSERT INTO `empleados` VALUES (1,'jimmy fernando','Cantor Garcia','1992-04-25','m','Programador',2000000,2000000,2500000,2100000,190000),(2,'alberto','sanchez','2019-02-28','m','guarda',1000000,900000,850000,700000,1000000),(3,'ana','sanchez','2019-02-06','f','diseñadora',2500000,2000000,2200000,2450000,2600000),(4,'Andrea','Corzo','2019-02-03','f','Programadora Junior',1200000,1100000,1000000,1300000,1450000);
...
INSERT INTO `perfiles` VALUES (1,'administrador'),(2,'cliente'),(3,'guarda'),(5,'nuevo perfil');
...
-- Dump completed on 2019-05-03  0:10:31
